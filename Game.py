...
buildings_info = [
    ...
    {"key": "broken_shack", "name": "🛖 Сарай", "base_income": 3, "base_capacity": 250, "cost": 200, "upgrade_cost_base": 100, "upgrade_capacity_bonus": 125, "funny": "Лучше, чем ничего."},
    {"key": "hut", "name": "🏠 Хижина", "base_income": 8, "base_capacity": 500, "cost": 500, "upgrade_cost_base": 250, "upgrade_capacity_bonus": 250, "funny": "Уютно и прибыльно."},
    {"key": "coffee_stand", "name": "☕ Кофейня", "base_income": 15, "base_capacity": 1000, "cost": 1000, "upgrade_cost_base": 500, "upgrade_capacity_bonus": 500, "funny": "Кофе с собой! Клиенты в восторге."},
    {"key": "small_farm", "name": "🚜 Ферма", "base_income": 30, "base_capacity": 2000, "cost": 2500, "upgrade_cost_base": 1250, "upgrade_capacity_bonus": 1000, "funny": "Экологически чистые монеты."},
    {"key": "shop", "name": "🛒 Магазин", "base_income": 60, "base_capacity": 5000, "cost": 5000, "upgrade_cost_base": 2500, "upgrade_capacity_bonus": 2500, "funny": "Купи-продай."},
    {"key": "gas_station", "name": "⛽ Заправка", "base_income": 120, "base_capacity": 10000, "cost": 12000, "upgrade_cost_base": 6000, "upgrade_capacity_bonus": 5000, "funny": "Бензин нынче дорогой."},
    {"key": "workshop", "name": "🛠️ Мастерская", "base_income": 250, "base_capacity": 20000, "cost": 25000, "upgrade_cost_base": 12500, "upgrade_capacity_bonus": 10000, "funny": "Работа кипит."},
    {"key": "warehouse", "name": "🏬 Склад", "base_income": 500, "base_capacity": 50000, "cost": 60000, "upgrade_cost_base": 30000, "upgrade_capacity_bonus": 25000, "funny": "Место для твоих гор золота."},
    {"key": "hotel", "name": "🏨 Отель", "base_income": 1000, "base_capacity": 100000, "cost": 150000, "upgrade_cost_base": 75000, "upgrade_capacity_bonus": 50000, "funny": "Все включено, особенно прибыль."},
    ...
    {"key": "casino", "name": "🎰 Казино", "base_income": 10000, "base_capacity": 1500000, "cost": 2500000, "upgrade_cost_base": 1250000, "upgrade_capacity_bonus": 750000, "funny": "Казино всегда в выигрыше (ты тоже)."},
    ...
    {"key": "supermarket", "name": "🛍️ Супермаркет", "base_income": 50000, "base_capacity": 7000000, "cost": 15000000, "upgrade_cost_base": 7500000, "upgrade_capacity_bonus": 3500000, "funny": "Очереди на кассах."},
    {"key": "corporation", "name": "🌆 Корпорация", "base_income": 100000, "base_capacity": 15000000, "cost": 50000000, "upgrade_cost_base": 25000000, "upgrade_capacity_bonus": 7500000, "funny": "Мировое господство."},
    ...
    {"key": "empire", "name": "🏰 Империя", "base_income": 1000000, "base_capacity": 150000000, "cost": 2000000000, "upgrade_cost_base": 1000000000, "upgrade_capacity_bonus": 75000000, "funny": "Ты — король мира."},
    {"key": "dyson_sphere", "name": "☀️ Сфера Дайсона", "base_income": 5000000, "base_capacity": 500000000, "cost": 10000000000, "upgrade_cost_base": 5000000000, "upgrade_capacity_bonus": 250000000, "funny": "Энергия целой звезды в кармане."}
]

# ═══════════════════════════════════════════════════════════
# СПИСОК ОСНОВНЫХ ЗАДАНИЙ (ПО 5 ШТУК + БОНУСЫ)
# ═══════════════════════════════════════════════════════════
main_quests_info = [
    ...
    {"key": "build_5", "type": "buildings_count", "target": 5, "name": "🏗️ Начинающий прораб", "desc": "Построй любые 5 сооружений", "rew_coins": 1000, "rew_tap": 0, "rew_chance": 0},
    {"key": "build_10", "type": "buildings_count", "target": 10, "name": "🏗️ Главный архитектор", "desc": "Построй любые 10 сооружений", "rew_coins": 100000, "rew_tap": 0, "rew_chance": 0},
    {"key": "build_20", "type": "buildings_count", "target": 20, "name": "🏗️ Городской застройщик", "desc": "Построй любые 20 сооружений", "rew_coins": 100000000, "rew_tap": 0, "rew_chance": 0},
    {"key": "build_30", "type": "buildings_count", "target": 30, "name": "🏗️ Бетонный магнат", "desc": "Построй любые 30 сооружений", "rew_coins": 1000000000, "rew_tap": 0, "rew_chance": 0},
    {"key": "build_50", "type": "buildings_count", "target": 50, "name": "🏗️ Владелец мегаполиса", "desc": "Построй любые 50 сооружений", "rew_coins": 100000000000, "rew_tap": 0, "rew_chance": 0},
    
    # ТИП 3: КУПИТЬ УЛУЧШЕНИЯ (+ БОНУС К ТАПУ)
    {"key": "upg_3", "type": "upgrades_count", "target": 3, "name": "🖐️ Новые ощущения", "desc": "Купи 3 разных пальца", "rew_coins": 500, "rew_tap": 5, "rew_chance": 0},
    {"key": "upg_5", "type": "upgrades_count", "target": 5, "name": "🖐️ Коллекционер рук", "desc": "Купи 5 разных пальцев", "rew_coins": 1000, "rew_tap": 15, "rew_chance": 0},
    {"key": "upg_8", "type": "upgrades_count", "target": 8, "name": "🖐️ Золотая ручка", "desc": "Купи 8 разных пальцев", "rew_coins": 5000, "rew_tap": 50, "rew_chance": 0},
    {"key": "upg_10", "type": "upgrades_count", "target": 10, "name": "🖐️ Техно-эволюция", "desc": "Купи 10 разных пальцев", "rew_coins": 20000, "rew_tap": 150, "rew_chance": 0},
    {"key": "upg_15", "type": "upgrades_count", "target": 15, "name": "🖐️ Бог кликов", "desc": "Купи 15 разных пальцев", "rew_coins": 100000, "rew_tap": 500, "rew_chance": 0},
    
    # ТИП 4: КЛИКИ (+ БОНУС К ТАПУ)
    {"key": "click_1k", "type": "clicks", "target": 1000, "name": "👆 Быстрый палец", "desc": "Сделай 1 000 тапов", "rew_coins": 2000, "rew_tap": 1, "rew_chance": 0},
    {"key": "click_5k", "type": "clicks", "target": 5000, "name": "👆 Клик-машина", "desc": "Сделай 5 000 тапов", "rew_coins": 10000, "rew_tap": 5, "rew_chance": 0},
    {"key": "click_20k", "type": "clicks", "target": 20000, "name": "👆 Скорость света", "desc": "Сделай 20 000 тапов", "rew_coins": 30000, "rew_tap": 10, "rew_chance": 0},
    {"key": "click_50k", "type": "clicks", "target": 50000, "name": "👆 Разрушитель экранов", "desc": "Сделай 50 000 тапов", "rew_coins": 100000, "rew_tap": 50, "rew_chance": 0},
    {"key": "click_100k", "type": "clicks", "target": 100000, "name": "👆 Титан кликов", "desc": "Сделай 100 000 тапов", "rew_coins": 200000, "rew_tap": 100, "rew_chance": 0},
    
    # ТИП 5: ДОХОД
    {"key": "inc_100", "type": "income", "target": 100, "name": "💤 Маленький ручеек", "desc": "Достигни дохода 100 монет/мин", "rew_coins": 5000, "rew_tap": 0, "rew_chance": 0},
    {"key": "inc_1k", "type": "income", "target": 1000, "name": "💤 Денежная река", "desc": "Достигни дохода 1 000 монет/мин", "rew_coins": 20000, "rew_tap": 0, "rew_chance": 0},
    {"key": "inc_5k", "type": "income", "target": 5000, "name": "💤 Нефтяная вышка", "desc": "Достигни дохода 5 000 монет/мин", "rew_coins": 50000, "rew_tap": 0, "rew_chance": 0},
    {"key": "inc_20k", "type": "income", "target": 20000, "name": "💤 Банковский магнат", "desc": "Достигни дохода 20 000 монет/мин", "rew_coins": 150000, "rew_tap": 0, "rew_chance": 0},
    {"key": "inc_100k", "type": "income", "target": 100000, "name": "💤 Хозяин мира", "desc": "Достигни дохода 100 000 монет/мин", "rew_coins": 500000, "rew_tap": 0, "rew_chance": 0},
    ...
    {"key": "spend_500k", "type": "spent", "target": 500000, "name": "💸 Крупный инвестор", "desc": "Потрать в сумме 500 000 монет", "rew_coins": 25000, "rew_tap": 0, "rew_chance": 0},
    {"key": "spend_1m", "type": "spent", "target": 1000000, "name": "💸 Золотой кит", "desc": "Потрать в сумме 1 000 000 монет", "rew_coins": 50000, "rew_tap": 0, "rew_chance": 0},
    {"key": "spend_5m", "type": "spent", "target": 5000000, "name": "💸 Акула бизнеса", "desc": "Потрать в сумме 5 000 000 монет", "rew_coins": 200000, "rew_tap": 0, "rew_chance": 0},
    {"key": "spend_20m", "type": "spent", "target": 20000000, "name": "💸 Король расходов", "desc": "Потрать в сумме 20 000 000 монет", "rew_coins": 1000000, "rew_tap": 0, "rew_chance": 0},
...
def check_daily_reset(user):
    ...
    if user["daily_progress"]["date"] != today:
        last_date_str = user["daily_progress"]["date"]
        try:
            last_date = date.fromisoformat(last_date_str) if last_date_str else None
            yesterday = date.today() - timedelta(days=1)
            if last_date != yesterday and last_date != date.today():
                 pass
        except:
            pass
        user["daily_progress"] = {
            "date": today,
            "clicks": 0, "upgrades": 0, "claims": 0, "completed": [], "all_done": False
        }
...
async def show_main_interface(message: Message, user_id: int):
    ...
    text = (f"🌟<b>Добро пожаловать в Tycoon Empire!</b>🌟\n\n"
            ...
            f"🖐️ Текущий палец: {finger_name} (+{finger_bonus} за тап)\n\n"
...
async def promo_handler(message: Message):
    ...
    # Сценарий 1: НЕ ЗАРЕГИСТРИРОВАН
    if user_id not in users:
        try: 
            # Ставим реакцию ошибки
    ...
    # Сценарий 2: ПРОСТО СПРОСИЛ /promo
    if len(args) < 2:
        try:
            # Ставим реакцию "вопроса" или скуки
    ...
    # СТАВИМ РЕАКЦИЮ (Гарантированно перед ответом)
    try:
...
async def handle_text(message: Message):
    ...
    # --- ОБЫЧНЫЕ КОМАНДЫ ---
    if message.text == "💰 Тапать монеты":
        await show_tap(message)
    elif message.text == "📊 Профиль":
        await profile(message)
    elif message.text == "🏪 Магазин":
        await shop(message)
    elif message.text == "🏗️ Сооружения":
        await buildings_shop(message)
    elif message.text == "📝 Задания":
        await quests_menu(message)
    elif message.text == "👥 Рефералка":
        await referral(message)
    elif message.text == "🏆 Топ-10":
        await top10_menu(message)
...
async def privacy_settings(message: Message):
    ...
    text = (f"🔒 **Настройки конфиденциальности**\n\n"
            ...
            f"то незнакомые люди не смогут открыть ваш профиль, даже если здесь включено 'Включено'.\n\n"
...
async def tap(callback: CallbackQuery):
    ...
    text = (f"🌟<b>Добро пожаловать в Tycoon Empire!</b>🌟\n\n"
            f"💰 Баланс: {user['balance']:,} монет\n"
            f"💎 Алмазы: {user['diamonds']}\n"
            f"🖐️ За тап: +{earn} монет\n"
            f"🖐️ Текущий палец: {finger_name}\n\n"
            f"Ты становишься всё ближе к вершине! 🔥\n"
            f"Продолжай тапать!").replace(",", " ")
            
    try:
        await callback.message.edit_text(text, reply_markup=tap_button(), parse_mode="HTML")
    except:
        pass
...
async def quests_main_list(callback: CallbackQuery):
    ...
    kb.inline_keyboard.append([InlineKeyboardButton(text="🔙 Назад", callback_data="quests_back_root")])
    try:
        await callback.message.edit_text("📜 **Основные задания**", reply_markup=kb, parse_mode="Markdown")
    except:
        await callback.message.answer("📜 **Основные задания**", reply_markup=kb, parse_mode="Markdown")
...
async def view_quest(callback: CallbackQuery):
    ...
    if quest['rew_tap'] > 0: reward_parts.append(f"{quest['rew_tap']} к тапу")
    if quest['rew_chance'] > 0: reward_parts.append(f"{quest['rew_chance']*100:.1f}% к шансу алмаза")
...
async def profile(message: Message):
    ...
    text = (f"👑 <b>ТВОЙ ПРОФИЛЬ</b> 👑\n\n"
            ...
            f"🔥 За один тап: +{current_finger_bonus} монет\n"
            ...
            f"📝 Основных заданий: {len(user['completed_quests'])}\n"
            f"📅 Серия ежедневных: {user['daily_streak']} дн.\n"
...
async def shop(message: Message, page=0):
    ...
    for i, info in enumerate(current_items):
        ...
        if bought:
            kb.inline_keyboard.append([InlineKeyboardButton(text=f"{info['name']} ✅", callback_data="bought_finger")])
        elif unlocked:
            kb.inline_keyboard.append([InlineKeyboardButton(text=info['name'], callback_data=f"view_finger_{key}_{page}")])
        else:
            kb.inline_keyboard.append([InlineKeyboardButton(text=f"{info['name']} 🔒", callback_data="locked_finger")])
    
    nav_row = []
    if page > 0:
        nav_row.append(InlineKeyboardButton(text="⬅️ Туда", callback_data=f"shop_page_{page-1}"))
    if page < total_pages - 1:
        nav_row.append(InlineKeyboardButton(text="Сюда ➡️", callback_data=f"shop_page_{page+1}"))
    if nav_row:
...
# ═══════════════════════════════════════════════════════════
# МАГАЗИН СООРУЖЕНИЙ (С ПАГИНАЦИЕЙ)
# ═══════════════════════════════════════════════════════════
async def buildings_shop(message: Message, page=0):
    ...
    for i, info in enumerate(current_items):
        ...
        if level > 0:
            kb.inline_keyboard.append([InlineKeyboardButton(text=f"{info['name']} (Ур. {level})", callback_data=f"view_building_{key}_{page}")])
        elif unlocked:
            kb.inline_keyboard.append([InlineKeyboardButton(text=info['name'], callback_data=f"view_building_{key}_{page}")])
        else:
            kb.inline_keyboard.append([InlineKeyboardButton(text=f"{info['name']} 🔒", callback_data="locked_building")])
            
    nav_row = []
    if page > 0:
        nav_row.append(InlineKeyboardButton(text="⬅️ Туда", callback_data=f"build_page_{page-1}"))
    if page < total_pages - 1:
        nav_row.append(InlineKeyboardButton(text="Сюда ➡️", callback_data=f"build_page_{page+1}"))
    if nav_row:
        kb.inline_keyboard.append(nav_row)
...
async def show_top10_category(callback: CallbackQuery):
    ...
    for i, (uid, data) in enumerate(top, 1):
        ...
        if privacy_on:
            user_link = f'<a href="tg://user?id={uid}">{safe_name}</a>'
        else:
            user_link = safe_name
        
        if category == "balance":
            val = f"{data['balance']:,}".replace(",", " ") + " монет"
        elif category == "diamonds":
            val = f"{data['diamonds']} 💎"
        elif category == "referrals":
            val = f"{data['referrals']} друзей"
